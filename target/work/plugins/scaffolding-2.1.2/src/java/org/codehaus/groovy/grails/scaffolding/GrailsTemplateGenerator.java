...
public interface GrailsTemplateGenerator {
	...
	/**
	 * Generates a taskmanager for the supplied domain class.
	 * @param domainClass The DomainClass to generate views for
	 * @param destDir The destination directory to generate views to
	 */
	...
	/**
	 * Generates a Restful taskmanager for the supplied domain class.
	 * @param domainClass The DomainClass to generate views for
	 * @param destDir The destination directory to generate views to
	 */
	...
	/**
	 * Generates a taskmanager for the specified domain class, writing the result to the specified
	 * java.io.Writer instance.
	 *
	 * @param domainClass The domain class to generate a taskmanager for
	 * @param out The Writer to write to
	 */
	void generateController(GrailsDomainClass domainClass, Writer out) throws IOException;

	/**
	 * Generates a taskmanager unit test for the specified domain class.
	 *
	 * @param domainClass The domain class
	 * @param destDir The destination
	 */
