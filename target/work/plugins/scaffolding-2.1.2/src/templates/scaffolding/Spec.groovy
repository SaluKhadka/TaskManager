...
class ${className}ControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        ...
        then:"The taskmanger is correct"
    ...
    void "Test the create action returns the correct model"() {
        ...
        then:"The taskmanger is correctly created"
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        then:"The create view is rendered again with the correct taskmanger"
            model.${modelName}!= null
            view == 'create'
    ...
    void "Test that the show action returns the correct model"() {
        ...
        then:"A taskmanger is populated containing the domain instance"
