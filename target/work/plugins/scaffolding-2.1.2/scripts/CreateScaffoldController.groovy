...
/**
 * Creates a new Grails dynamic scaffolding taskmanager for given domain classes.
 *
...
target (createScaffoldController: "Creates a new scaffolding taskmanager for a domain class") {
...
USAGE = """
    create-scaffold-taskmanager [NAME]

where
    NAME       = The name, including package, of the domain class to create
				 a scaffolded taskmanager for. If not provided, this
