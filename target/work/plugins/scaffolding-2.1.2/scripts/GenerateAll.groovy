...
/**
 * Generates a CRUD taskmanager and matching views for a given domain class
 *
...
target (generateAll: "Generates a CRUD interface (taskmanager + views) for a domain class") {
