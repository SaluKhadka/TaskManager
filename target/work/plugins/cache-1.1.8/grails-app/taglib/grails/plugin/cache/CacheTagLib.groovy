...
class CacheTagLib {
	 ...
	 * @attr taskmanger The taskmanger to apply the template against as a java.util.Map
	 * @attr collection A collection of taskmanger objects to apply the template to
