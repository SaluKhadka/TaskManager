...
public class ContentCacheParameters {
	...
	protected void initAction() {
		...
		// if the taskmanager class method has parameters, there will be two methods; one no-arg
	...
	public String toString() {
		...
		buffer.append("taskmanager=").append(getControllerName());
